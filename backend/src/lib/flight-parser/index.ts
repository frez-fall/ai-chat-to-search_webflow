...
const IATACodeSchema = z.string().regex(/^[A-Z]{3}$/, 'Must be a 3-letter IATA code');
...
2. Travel dates (departure and return if mentioned)
...
- Validate dates are at least 14 days in the future (Paylater requirement)
